...
3. LOGOUT USER button (only visible when a user is logged in, destructive/outlined style)
...
- Four buttons:
  ...
  4. CLEAR ALL - destructive/outlined style, calls OneSignal.Notifications.clearAll() to remove all delivered notifications
